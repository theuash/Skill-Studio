    ...
    >
      <div className="flip-card-inner w-full h-full">
        ...
        <motion.div
          ...
          className="flip-card-front w-full h-full rounded-2xl p-6 flex flex-col cursor-pointer"
          style={{
        ...
        {/* Back */}
        <div
          className="flip-card-back rounded-2xl p-5 flex flex-col cursor-pointer"
          style={{
            background: 'var(--surface)',
        ...
        >
          ...
          <div className="flex gap-2 mt-4" onClick={e => e.stopPropagation()}>
            <Link
              to={`/roadmap/${company.id}/software-engineer`}
